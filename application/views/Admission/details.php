    ...
    <div class="">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h3 class="panel-title">Form ID#: <?php echo $admissiondata["form_id"]; ?>
                    <div class="btn-group pull-right">


                        <a href="<?php echo site_url("Admission/index"); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                </h3>
            </div>
            <div class="panel-body">
                ...
                <div class="col-md-12" id='printArea'>
                    ...
                    <?php
                    $this->load->view('Admission/detailsbase', array("admissiondata" => $admissiondata));
                    ?>
